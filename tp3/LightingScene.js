...
<<<<<<< HEAD
	...
	this.materialtables = new CGFappearance(this);
	this.materialtables.setAmbient(0.3,0.1,0.1,0.3);
	this.materialtables.setDiffuse(1,0,0,1);
	this.materialtables.setSpecular(0.8,0.8,0.8,1);	
	this.materialtables.setShininess(200);
...
/*	this.lights[3].setPosition(4, 6, 5, 1);
	...
	this.lights[3].setSpecular(1.0,1.0,0,1.0);
	this.lights[3].enable();
	this.lights[3].setConstantAttenuation(0.9);
	this.lights[3].setLinearAttenuation(0.2);
	this.lights[3].setQuadraticAttenuation(0.7);
	this.lights[3].setPosition(4, 6.0, 5.0, 1.0);
*/
